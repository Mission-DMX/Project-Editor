...
"""An error occured but the current show is still running"""
Global___ShowFileApplyState: typing_extensions.TypeAlias = ShowFileApplyState
...
class enter_scene(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["scene_id", b"scene_id"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___enter_scene: typing_extensions.TypeAlias = enter_scene
...
class load_show_file(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["goto_default_scene", b"goto_default_scene", "show_data", b"show_data"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___load_show_file: typing_extensions.TypeAlias = load_show_file
...
class update_parameter(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["filter_id", b"filter_id", "parameter_key", b"parameter_key", "parameter_value", b"parameter_value", "scene_id", b"scene_id"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___update_parameter: typing_extensions.TypeAlias = update_parameter
