...
Global___ButtonState: typing_extensions.TypeAlias = ButtonState
...
class _ButtonCodeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ButtonCode.ValueType], builtins.type):
    ...
    BTN_TRACK_CONSOLE: _ButtonCode.ValueType  # 40
    """End of block of internally handled buttons
    Show the direct console and ask if fish should switch to direct mode if it is in filter mode
    """
    BTN_PAN_EDITSHOW: _ButtonCode.ValueType  # 41
    """Open the show file editor"""
    BTN_EQ_SHOWUI: _ButtonCode.ValueType  # 42
    """Open the show UI display and ask if fish should switch to filter mode if it is in direct mode"""
    BTN_SEND_VISUALIZER: _ButtonCode.ValueType  # 43
    """Open the visualizer view in the current open window"""
    BTN_PLUGIN_PATCH: _ButtonCode.ValueType  # 44
    """Open the patching menu and review current transmitted values"""
    BTN_INST_DEBUG: _ButtonCode.ValueType  # 45
    """Open the debug view"""
    BTN_NAMEVALUE_COMMITSHOW: _ButtonCode.ValueType  # 46
    """Apply the changes of the edited show"""
    BTN_BEATS_OOPS: _ButtonCode.ValueType  # 47
    """Undo the commit of show file or column updates (whichever was last); internally handled"""
    BTN_GLOBALVIEW_COMMITRDY: _ButtonCode.ValueType  # 48
    ...
    BTN_MIDITRACKS_FIND: _ButtonCode.ValueType  # 49
    """Find fixture button, further documentation in x-touch driver"""
    BTN_INPUTS_EVENTS: _ButtonCode.ValueType  # 50
    """Configure event sources and review incomming data"""
    BTN_AUDIOTRACKS: _ButtonCode.ValueType  # 51
    BTN_AUDIOINST: _ButtonCode.ValueType  # 52
    BTN_AUX_ASSETS: _ButtonCode.ValueType  # 53
    ...
    BTN_READOFF_GOTO: _ButtonCode.ValueType  # 68
    """Switch to a specific GUI page based on the input typed into the keypad."""
    BTN_WRITE_MOVEWINDOW: _ButtonCode.ValueType  # 69
    """If the button is pressed together with the buttons described next, it will move the selected window, using the F-Keys"""
...
BTN_TRACK_CONSOLE: ButtonCode.ValueType  # 40
"""End of block of internally handled buttons
Show the direct console and ask if fish should switch to direct mode if it is in filter mode
"""
BTN_PAN_EDITSHOW: ButtonCode.ValueType  # 41
"""Open the show file editor"""
BTN_EQ_SHOWUI: ButtonCode.ValueType  # 42
"""Open the show UI display and ask if fish should switch to filter mode if it is in direct mode"""
BTN_SEND_VISUALIZER: ButtonCode.ValueType  # 43
"""Open the visualizer view in the current open window"""
BTN_PLUGIN_PATCH: ButtonCode.ValueType  # 44
"""Open the patching menu and review current transmitted values"""
BTN_INST_DEBUG: ButtonCode.ValueType  # 45
"""Open the debug view"""
BTN_NAMEVALUE_COMMITSHOW: ButtonCode.ValueType  # 46
"""Apply the changes of the edited show"""
BTN_BEATS_OOPS: ButtonCode.ValueType  # 47
"""Undo the commit of show file or column updates (whichever was last); internally handled"""
BTN_GLOBALVIEW_COMMITRDY: ButtonCode.ValueType  # 48
"""Apply the chanes of all columns in READY-Mode; is blinking as long as some colums are in Ready/Wait mode; internally handled"""
BTN_MIDITRACKS_FIND: ButtonCode.ValueType  # 49
"""Find fixture button, further documentation in x-touch driver"""
BTN_INPUTS_EVENTS: ButtonCode.ValueType  # 50
"""Configure event sources and review incomming data"""
BTN_AUDIOTRACKS: ButtonCode.ValueType  # 51
BTN_AUDIOINST: ButtonCode.ValueType  # 52
BTN_AUX_ASSETS: ButtonCode.ValueType  # 53
"""Open the assets manager"""
...
BTN_READOFF_GOTO: ButtonCode.ValueType  # 68
"""Switch to a specific GUI page based on the input typed into the keypad."""
BTN_WRITE_MOVEWINDOW: ButtonCode.ValueType  # 69
"""If the button is pressed together with the buttons described next, it will move the selected window, using the F-Keys"""
...
Global___ButtonCode: typing_extensions.TypeAlias = ButtonCode
...
Global___lcd_color: typing_extensions.TypeAlias = lcd_color
...
class button_state_change(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["button", b"button", "new_state", b"new_state"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___button_state_change: typing_extensions.TypeAlias = button_state_change
...
class fader_position(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["column_id", b"column_id", "position", b"position"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___fader_position: typing_extensions.TypeAlias = fader_position
...
class rotary_encoder_change(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["amount", b"amount", "column_id", b"column_id"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___rotary_encoder_change: typing_extensions.TypeAlias = rotary_encoder_change
...
class remove_fader_bank_set(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["bank_id", b"bank_id"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___remove_fader_bank_set: typing_extensions.TypeAlias = remove_fader_bank_set
...
class desk_update(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["find_active_on_column_id", b"find_active_on_column_id", "jogwheel_change_since_last_update", b"jogwheel_change_since_last_update", "selected_bank", b"selected_bank", "selected_bank_set", b"selected_bank_set", "selected_column_id", b"selected_column_id", "seven_seg_display_data", b"seven_seg_display_data"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___desk_update: typing_extensions.TypeAlias = desk_update
...
class fader_column(google.protobuf.message.Message):
    ...
    class hsi_color(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["hue", b"hue", "intensity", b"intensity", "saturation", b"saturation"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class hsi_u_color(google.protobuf.message.Message):
        ...
        _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["base", b"base"]
        def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["base", b"base", "uv", b"uv"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    class raw_fader_data(google.protobuf.message.Message):
        ...
        _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["b1", b"b1", "b2", b"b2", "b3", b"b3", "fader", b"fader", "meter_leds", b"meter_leds", "rotary_position", b"rotary_position", "select", b"select"]
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["color_with_uv", b"color_with_uv", "plain_color", b"plain_color", "raw_data", b"raw_data", "value", b"value"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["bottom_lcd_row_inverted", b"bottom_lcd_row_inverted", "color_with_uv", b"color_with_uv", "column_id", b"column_id", "display_color", b"display_color", "lower_display_text", b"lower_display_text", "plain_color", b"plain_color", "raw_data", b"raw_data", "top_lcd_row_inverted", b"top_lcd_row_inverted", "upper_display_text", b"upper_display_text", "value", b"value"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType_value: typing_extensions.TypeAlias = typing.Literal["plain_color", "color_with_uv", "raw_data"]
...
Global___fader_column: typing_extensions.TypeAlias = fader_column
...
class add_fader_bank_set(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["bank_id", b"bank_id", "banks", b"banks", "default_active_fader_bank", b"default_active_fader_bank"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___add_fader_bank_set: typing_extensions.TypeAlias = add_fader_bank_set
