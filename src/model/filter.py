...
class FilterTypeEnumeration(IntFlag):
    ...
    FILTER_TIME_ON_DELAY_8BIT = 33
    FILTER_TIME_ON_DELAY_16BIT = 34
    FILTER_TIME_ON_DELAY_FLOAT = 35
    FILTER_TIME_OFF_DELAY_8BIT = 36
    FILTER_TIME_OFF_DELAY_16BIT = 37
    FILTER_TIME_OFF_DELAY_FLOAT = 38
    FILTER_FADER_RAW = 39
    FILTER_FADER_HSI = 40
