...
type_to_node: dict[int, str] = {
        ...
        FilterTypeEnumeration.FILTER_TIME_ON_DELAY_8BIT: TimeSwitchOnDelay8BitNode.nodeName,
        FilterTypeEnumeration.FILTER_TIME_ON_DELAY_16BIT: TimeSwitchOnDelay16BitNode.nodeName,
        FilterTypeEnumeration.FILTER_TIME_ON_DELAY_FLOAT: TimeSwitchOnDelayFloatNode.nodeName,
        FilterTypeEnumeration.FILTER_TIME_OFF_DELAY_8BIT: TimeSwitchOffDelay8BitNode.nodeName,
        FilterTypeEnumeration.FILTER_TIME_OFF_DELAY_16BIT: TimeSwitchOffDelay16BitNode.nodeName,
        FilterTypeEnumeration.FILTER_TIME_OFF_DELAY_FLOAT: TimeSwitchOffDelayFloatNode.nodeName,
