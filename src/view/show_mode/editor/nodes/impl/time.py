...
class TimeSwitchOnDelay8BitNode(FilterNode):
    ...
    def __init__(self, model, name):
        super().__init__(model=model, filter_type=FilterTypeEnumeration.FILTER_TIME_ON_DELAY_8BIT, name=name, terminals={
            'value_in': {'io': 'in'},
            'time': {'io': 'in'},
            'value': {'io': 'out'}
        })
...
class TimeSwitchOnDelay16BitNode(FilterNode):
    ...
    def __init__(self, model, name):
        super().__init__(model=model, filter_type=FilterTypeEnumeration.FILTER_TIME_ON_DELAY_16BIT, name=name, terminals={
            'value_in': {'io': 'in'},
            'time': {'io': 'in'},
            'value': {'io': 'out'}
        })
...
class TimeSwitchOnDelayFloatNode(FilterNode):
    ...
    def __init__(self, model, name):
        super().__init__(model=model, filter_type=FilterTypeEnumeration.FILTER_TIME_ON_DELAY_FLOAT, name=name, terminals={
            'value_in': {'io': 'in'},
            'time': {'io': 'in'},
            'value': {'io': 'out'}
        })
...
class TimeSwitchOffDelay8BitNode(FilterNode):
    ...
    def __init__(self, model, name):
        super().__init__(model=model, filter_type=FilterTypeEnumeration.FILTER_TIME_OFF_DELAY_8BIT, name=name, terminals={
            'value_in': {'io': 'in'},
            'time': {'io': 'in'},
            'value': {'io': 'out'}
        })
...
class TimeSwitchOffDelay16BitNode(FilterNode):
    ...
    def __init__(self, model, name):
        super().__init__(model=model, filter_type=FilterTypeEnumeration.FILTER_TIME_OFF_DELAY_16BIT, name=name, terminals={
            'value_in': {'io': 'in'},
            'time': {'io': 'in'},
            'value': {'io': 'out'}
        })
...
class TimeSwitchOffDelayFloatNode(FilterNode):
    ...
    def __init__(self, model, name):
        super().__init__(model=model, filter_type=FilterTypeEnumeration.FILTER_TIME_OFF_DELAY_FLOAT, name=name, terminals={
            'value_in': {'io': 'in'},
            'time': {'io': 'in'},
            'value': {'io': 'out'}
        })
