...
class SequencerControlUIWidget(UIWidget):
    """
    This show UI widget displays information about an associated sequencer. Most notably the current running
    transitions.
    """
    ...
    def _update_received(self, param: FilterMode_pb2.update_parameter) -> None:
        """Refreshes the current sequence list on new updates from the filter."""
